...
import DorothyImg from "../assets/team/optimized/Dorothy1_UF9A2316-Edit-2.webp";
import AllysonImg from "../assets/team/optimized/Allyson1_UF9A2325-Edit-2.webp";
import VeronicaImg from "../assets/team/optimized/veronica.webp";
...
export const teamMembers = [
  {
    ...
    bio: [
      "Trisha Morales Padia is an experienced attorney focused on estate planning and criminal law. Before pursuing law, she built a successful career in marketing and advertising as a media buyer. In 2013, she earned her law degree from St. Maryâ€™s University School of Law, bringing her strategic mindset and problem-solving skills into the legal field.",
      "Trisha is passionate about guiding clients through lifeâ€™s most challenging legal matters, whether navigating the criminal justice system or planning for the future. She believes in clear communication, realistic expectations, and strong advocacy to ensure her clients feel informed and supported every step of the way.",
    ...
    achievements: [
      ...
      "Top Criminal Defense Lawyer, Top DWI Lawyer, and Top Family Law Lawyer between 2015 and 2020",
      "Best San Antonio Female Lawyer and Top San Antonio DUI/DWI Attorney, 2021.",
    ],
  ...
  },
  {
    ...
    bio: [
      ...
      "Dorothyâ€™s journey into the legal field was inspired by a former supervisorâ€™s dream of attending law school. Supporting that vision sparked her own passion for the legal profession and her commitment to making a positive impact on clientsâ€™ lives. One of her most rewarding experiences came from her time in immigration law, where she witnessed firsthand how legal assistance can transform lives.",
      "Clients appreciate Dorothyâ€™s meticulous attention to detail and her dedication to providing thorough, compassionate support. Her commitment to helping both attorneys and clients ensures that every case is handled with care, precision, and a focus on achieving the best outcomes.",
    ],
  ...
  },
  {
    ...
    bio: [
      "Allyson brings a unique blend of experience and passion to Morales Padia Law, with an Associate Degree in Psychology from Del Mar College and a Bachelor of Science in Business Management from Western Governors University. With over four years of legal experience, including three years at Morales Padia Law, Allyson supports contracts, billing, business operations, and HR management. Her 11 years of experience in the accounting field have sharpened her analytical skills, particularly when it comes to navigating complex financial matters and ensuring smooth operations.",
      "In her role at Morales Padia Law, Allyson ensures clients feel confident and informed throughout the billing process, offering clear, accurate guidance and simplifying complex financial aspects. She is dedicated to making every client's experience as seamless and stress-free as possible. Whether it's resolving billing concerns or managing contracts, Allysonâ€™s commitment to transparency and open communication ensures that every client receives personalized, efficient service.",
      "Beyond her professional role, Allyson is a busy mom to a 5-year-old daughter who keeps her on her toes with soccer, basketball, baseball, and dance. When sheâ€™s not attending practices or cheering her on, Allyson enjoys playing video games, knitting, painting, and strumming her ukulele. She also finds time to give back to her community by volunteering at her daughterâ€™s school.",
  ...
  },
  {
    ...
    bio: [
      ...
      "Elenaâ€™s inspiration for pursuing a career in the legal field comes from her fascination with the law and her belief that justice will always prevail. A personal experience where she and her children felt the system failed them deeply influenced her career path and drives her commitment to advocate for victims and be their voice. Known for her stubbornness as a Taurus, Elena is serious, analytical, and passionate about ensuring that others receive the justice they deserve.",
    ],
    quote:
      "At his best, man is the noblest of all animals; separated from law and justice he is the worst.",
    quoteAuthor: "Aristotle",
    footerTitles: ["Family Law", "Custody", "Divorce Support", "Client Care"],
  },
  {
    id: "alexandra-johnson",
    ...
    bio: [
      ...
      "At Morales Padia Law, Alexandra focuses on estate planning, where she is dedicated to helping families plan for the future and protect their legacies. What she enjoys most about working with clients is the opportunity to learn about their family dynamics and values, ensuring their estate plans reflect what is most important to them. Alexandraâ€™s approach is centered around listening to her clients' needs, taking the time to understand their specific situation, and creating thoughtful solutions.",
