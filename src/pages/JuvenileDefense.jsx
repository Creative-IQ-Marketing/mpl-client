  ...
  return (
    <div className="bg-white min-h-screen">
      <CleanServiceHero
        ...
        subtitle="Protecting young people's futures in the justice system."
        infoTitle="Understanding Juvenile Defense"
        infoDescription="When a young person is charged with a crime, their future is at stake. The juvenile justice system operates differently from adult criminal court, with different rules, procedures, and penalties. Skilled representation is critical to protect a young person's rights and minimize long-term consequences."
      />
      <OverviewSection />
      <DifferencesSection />
      <OffensesSection />
      ...
      <div className="container-custom">
        <div className="bg-white rounded-2xl border border-gray-200 shadow-md p-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            The juvenile defense system is a compassionate structure designed to
            help youth under 17 years old who are accused of criminal offenses.
            The focus is on rehabilitation and future opportunity, not
            punishment. We guide families through a unique legal process,
            protecting children’s rights and long‑term prospects while seeking
            second chances.
          </p>
        </div>
      </div>
...
const DifferencesSection = () => {
  const rows = [
    {
      label: "Primary Goal",
      juvenile: "Rehabilitation & Treatment",
      adult: "Punishment & Deterrence",
    },
    {
      label: "Proceedings",
      juvenile: "Generally Confidential",
      adult: "Public Record",
    },
    {
      label: "Terminology",
      juvenile: "Adjudication, Disposition",
      adult: "Trial, Sentencing",
    },
    {
      label: "Jury Trial",
      juvenile: "No Jury in Most Cases",
      adult: "Right to Jury Trial",
    },
    {
      label: "Consequences",
      juvenile: "Probation, Treatment, Diversion",
      adult: "Fines, Prison, Probation",
    },
  ];
  return (
    <section className="py-16 bg-white">
      <div className="container-custom">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-md overflow-hidden">
          ...
          <div className="grid grid-cols-3 gap-0">
            <div className="p-4 border-b border-r font-serif font-semibold text-mpl-navy">
              Aspect
            </div>
            <div className="p-4 border-b border-r font-serif font-semibold text-mpl-navy">
              Juvenile Court
            </div>
            <div className="p-4 border-b font-serif font-semibold text-mpl-navy">
              Adult Court
            </div>
            {rows.map((r, i) => (
              <React.Fragment key={i}>
                <div className="p-4 border-t border-r bg-gray-50">
                  {r.label}
                </div>
  ...
  const items = [
    {
      ...
      icon: Shield,
      desc: "Safeguarding constitutional rights during questioning, hearings, and proceedings.",
    },
    {
      title: "Family Involvement",
      icon: Users,
      desc: "Engaging families at every stage for support and informed decisions.",
    },
    {
      title: "Educational Advocacy",
      icon: School,
      desc: "Protecting school records and advocating for appropriate services.",
    },
    {
      title: "Treatment Focus",
      icon: Scale,
      desc: "Prioritizing counseling, treatment, and diversion over detention.",
    },
    {
      title: "Record Protection",
      icon: FileText,
      desc: "Planning and pursuing record sealing to protect future opportunities.",
    },
    {
      title: "Alternative Dispositions",
      icon: Gavel,
      desc: "Seeking community‑based programs and tailored probation terms.",
    },
  ];
  return (
    <section className="py-24 bg-white">
  ...
  const items = [
    {
      ...
      desc: "School disciplinary actions, suspensions, or expulsion can affect grades and graduation.",
    },
    {
      title: "Driving Privileges",
      desc: "Certain charges may affect licensing or lead to special restrictions.",
    },
    {
      title: "College Applications",
      desc: "Records may impact college admissions and scholarship eligibility.",
    },
    {
      title: "Employment Background",
      desc: "Juvenile records may appear in some checks and affect job prospects.",
    },
    {
      title: "Military Service",
      desc: "Recruiting decisions may consider juvenile history.",
    },
    {
      title: "Professional Licensing",
      desc: "State licensing boards can be affected by juvenile adjudications.",
    },
  ];
  return (
    <section className="py-24 bg-white">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">
                Juvenile adjudications are generally confidential, but
                consequences can still affect a young person’s life. Protect
                your child’s future by seeking experienced legal help.
              </p>
            </div>
          </div>
        ...
        <div className="bg-mpl-navy rounded-3xl p-12 md:p-20 text-center relative overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <p className="text-xl text-white/80 mb-10 leading-relaxed">
              When your child faces juvenile charges, their future is at stake.
              Contact our experienced defense team today.
            </p>
            <Link
              to="/contact"
