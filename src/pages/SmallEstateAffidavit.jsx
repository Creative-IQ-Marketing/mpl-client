          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-lg text-gray-700 mb-8 leading-relaxed">
                ...
                estates that meet specific requirements and can save significant
                time and expense.
              </p>
              ...
              <div className="space-y-6 my-12">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      Can be completed in weeks instead of months, without court
                      proceedings.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      Significantly lower legal fees and court costs compared to
                      full probate.
                    </p>
                  </div>
                </div>
            ...
            >
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-mpl-gold pl-4">
                  ...
                  <p className="text-gray-700">
                    The estate's gross value must be $75,000 or less (or in some
                    cases, meet additional qualifying requirements).
                  </p>
                </div>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              Let us help you determine if a Small Estate Affidavit is right for
              your situation.
            </p>
            <Link
              to="/contact"
