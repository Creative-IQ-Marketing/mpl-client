                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      ...
                      execution, testator lack of capacity, undue influence, or
                      fraud.
                    </p>
                  </div>
                </div>
            ...
            >
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-mpl-gold pl-4">
                  ...
                  <p className="text-gray-700">
                    We thoroughly evaluate the merits of your claim or defense,
                    gathering evidence and identifying key legal issues.
                  </p>
                </div>
                ...
                <div className="border-l-4 border-mpl-gold pl-4">
                  ...
                  <p className="text-gray-700">
                    If needed, we pursue or defend appeals to ensure your rights
            ...
            >
              ...
              <ul className="space-y-4">
                ...
                <li className="flex gap-3 items-start">
                  <CheckCircle className="w-6 h-6 text-mpl-gold flex-shrink-0 mt-1" />
                  <span className="text-gray-700">
                    <strong>Client focus:</strong> We prioritize your interests
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              Don't face estate litigation alone. Our experienced attorneys are
