      ...
      <div className="container-custom relative z-10 text-center">
        ...
        >
          ...
          <p className="text-lg md:text-xl lg:text-2xl text-gray-100 max-w-2xl mx-auto font-light leading-relaxed drop-shadow-md">
            Protecting your driving privileges, your record, and your future from the serious consequences of a DWI conviction.
          </p>
        </motion.div>
      </div>
      ...
      <div className="container-custom relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
        <div className="text-center md:text-left">
          ...
          <p className="text-white/80 max-w-2xl text-lg">
            You only have 15 days to request an ALR hearing to save your license. Act now.
          </p>
        </div>
  ...
  const steps = [
    {
      ...
      title: "Case Analysis",
      icon: FileSearch,
      desc: "We meticulously review the police report, video evidence, and breath/blood test results for any procedural errors or inaccuracies.",
      bullets: [
        "Review of stop legality",
        "Analysis of field sobriety tests",
        "Breath/Blood test validation",
        "Officer procedure check",
      ],
    },
    {
      id: 2,
      title: "ALR Hearing",
      icon: Ban,
      desc: "We represent you at the Administrative License Revocation (ALR) hearing to fight for your right to drive.",
      bullets: [
    ...
    },
    {
      ...
      icon: Scale,
      desc: "Based on our analysis, we develop a strategic defense to challenge the prosecution's case.",
      bullets: [
        "Motion to suppress evidence",
        "Challenge probable cause",
        "Expert witness consultation",
        "Negotiation for dismissal/reduction",
      ],
    },
    {
      id: 4,
      ...
      icon: Gavel,
      desc: "We provide strong representation in court, whether negotiating a plea or taking your case to trial.",
      bullets: [
        "Pre-trial hearings",
        "Plea bargaining",
        "Jury trial defense",
      ...
      <div className="container-custom">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-serif text-mpl-navy font-bold mb-4">
            Defending Your Rights & Record
          </h2>
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">
            A DWI charge doesn't have to mean a conviction. We fight to achieve the best possible outcome for your case.
          </p>
        </div>
        ...
        <div className="bg-mpl-navy rounded-3xl p-12 md:p-20 text-center relative overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <p className="text-xl text-white/80 mb-10 leading-relaxed">
              We are ready to fight for your license and your freedom. Contact us today for a confidential consultation.
            </p>
            <Link
              to="/contact"
