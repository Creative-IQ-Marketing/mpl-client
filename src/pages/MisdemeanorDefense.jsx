...
const MisdemeanorDefense = () => {
  return (
    <div className="bg-gray-50 min-h-screen">
      <CleanServiceHero
        title="Misdemeanor Defense in San Antonio"
        subtitle="Effective defense for misdemeanor charges."
        opening="A misdemeanor conviction, while less serious than a felony, can still impact your employment and future."
        infoTitle="What This Means"
        infoDescription="Misdemeanor charges in Texas can include fines, jail time, and a permanent record that affects employment and housing."
      />
      <WhyChooseSection />
      <ProcessSection />
      <BenefitsSection />
      ...
      <div className="container-custom relative z-10 text-left">
        ...
        >
          ...
          <p className="text-lg md:text-xl lg:text-2xl text-gray-100 max-w-2xl font-light leading-relaxed drop-shadow-md">
            Even misdemeanor charges can impact your employment, reputation, and
            future. Let us help you achieve the best possible outcome.
          </p>
  ...
  const features = [
    {
      ...
      desc: "Experience defending a wide range of misdemeanor charges.",
    },
    {
      icon: FileText,
      title: "Case Optimization",
      desc: "We explore all options to minimize consequences on your record.",
    },
    {
      icon: Gavel,
      title: "Strong Advocacy",
      desc: "Negotiation and trial experience to protect your interests.",
    },
  ];
    ...
    <section className="py-24 bg-white">
      <div className="container-custom text-center">
        ...
        <p className="text-lg text-gray-600 mb-12 max-w-2xl mx-auto">
          Dismissals, reduced charges, minimal consequences, and protection of
          your record.
        </p>
      </div>
    </section>
...
export default MisdemeanorDefense;
