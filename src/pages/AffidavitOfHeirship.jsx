  ...
  return (
    <>
      <SEO
        ...
        description="Learn about Affidavit of Heirship in Texas - a legal document establishing heirs' rights to property transfer after death without full probate."
        keywords="affidavit of heirship, heirship proceedings, probate alternative Texas"
        url="https://moralespadia.com/affidavit-of-heirship"
      />
      <StructuredData
        type="Article"
        data={{
          headline: "Affidavit of Heirship in Texas",
          description:
            "Legal method to establish heirship and transfer property without full probate.",
            ...
            <div className="max-w-4xl mx-auto">
              ...
              >
                ...
                <p className="text-lg text-gray-700 mb-8 leading-relaxed">
                  An Affidavit of Heirship is a legal document that identifies
                  the heirs of a person who died intestate (without a valid
                  will). When properly executed, it can be used to transfer real
                  property to the heirs without going through full probate
                  proceedings. This procedure is particularly useful for
                  straightforward situations with no disputes.
                </p>
              ...
              >
                ...
                <div className="space-y-6">
                  ...
                  <div className="border-l-4 border-mpl-gold pl-4">
                    ...
                    <p className="text-gray-700">
                      File the affidavit with the county clerk's office where
                  ...
                  <div className="border-l-4 border-mpl-gold pl-4">
                    ...
                    <p className="text-gray-700">
                      Use the recorded affidavit to transfer the property title
                      to the heirs' names.
                    </p>
                  </div>
                </div>
