  ...
  const services = [
    {
      ...
      icon: Users,
      description:
        "We provide compassionate support for all family-related legal matters.",
      items: [
    ...
    },
    {
      ...
      icon: FileText,
      description:
        "Secure your future and protect your loved ones with comprehensive estate planning.",
      items: [
        "Wills & Trusts",
        "Power of Attorney",
        "Medical Directives",
    ...
    },
    {
      ...
      icon: Scale,
      description:
        "Navigating the probate process can be complex. We guide you every step of the way.",
      items: [
    ...
    },
    {
      ...
      icon: Gavel,
      description:
        "Aggressive defense strategies to protect your rights and your future.",
      items: [
        "DWI/DUI Defense",
        "Drug Charges",
        "Domestic Violence",
  ...
  return (
    <div className="pt-8 pb-20">
              ...
              <div className="flex-1">
                <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <h2 className="text-3xl font-serif font-bold text-mpl-navy mb-4">
                      {service.title}
                    </h2>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      {service.items.map((item, i) => (
                        ...
                        >
                          <CheckCircle
                            size={18}
                            className="text-mpl-lightBlue mr-3 flex-shrink-0"
                          />
                          {item}
                        </div>
                      ))}
      ...
      <div className="mt-24 bg-mpl-gray py-16">
        <div className="container-custom text-center">
          <h2 className="text-3xl font-serif font-bold text-mpl-navy mb-6">
            Need Legal Assistance?
          </h2>
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            Don't navigate the legal system alone. Contact Morales Padia Law
