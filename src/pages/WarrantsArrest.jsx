...
const WarrantsArrest = () => {
  return (
    <div className="bg-gray-50 min-h-screen">
      <CleanServiceHero
        title="Warrants & Arrest Defense in San Antonio"
        subtitle="Strategic guidance if you're facing arrest or have a warrant."
        opening={[
          "Finding out you may have a warrant can be stressful and confusing.",
          "Ignoring it can make the situation worse.",
        ]}
        infoTitle="What This Means"
        infoDescription="Warrants can lead to arrest at any time. Addressing them proactively can often lead to better outcomes."
      />
      <WhyChooseSection />
      <ProcessSection />
      <BenefitsSection />
  ...
  const features = [
    {
      icon: Shield,
      title: "Safe Handling",
      desc: "We guide you through the next steps safely and strategically to minimize risk.",
    },
    {
      icon: FileText,
      title: "Warrant Confirmation",
      desc: "We confirm whether a warrant exists and advise you on your options.",
    },
    {
      icon: Clock,
      title: "Strategic Timing",
      desc: "We help you decide when and how to address the warrant for the best outcome.",
    },
    {
      icon: Gavel,
      title: "Court Preparation",
      desc: "We prepare you thoroughly for arrest or surrender procedures and court appearances.",
    },
    {
      icon: AlertTriangle,
      title: "Rights Protection",
      desc: "We ensure your constitutional rights are protected throughout the process.",
    },
    {
      icon: Phone,
      title: "Immediate Support",
      desc: "We're available to support you immediately and provide clear guidance.",
    },
  ];
      ...
      <div className="container-custom">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Warrants require careful, strategic handling.
          </p>
        </div>
...
const ProcessSection = () => {
  const steps = [
    {
      title: "Warrant Verification",
      desc: "We confirm the warrant details and help you understand what it means.",
    },
    {
      title: "Strategic Assessment",
      desc: "We evaluate your options for addressing the warrant.",
    },
    {
      title: "Preparation Plan",
      desc: "We help you prepare for arrest, surrender, or court appearance.",
    },
    {
      title: "Coordination",
      desc: "We coordinate with authorities when necessary to manage the situation.",
    },
    {
      title: "Court Representation",
      desc: "We represent you in initial appearances and bail hearings.",
    },
    {
      title: "Defense Development",
      desc: "We begin building your defense and work toward the best outcome.",
    },
  ];
      ...
      <div className="container-custom">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6">
            Our Warrant Defense Process
          </h2>
          <p className="text-lg text-gray-200 max-w-2xl mx-auto">
            Strategic action to protect your rights and your freedom
          </p>
        </div>
...
const BenefitsSection = () => {
  const benefits = [
    ...
    "Safe, strategic approach to addressing the warrant",
    "Minimized consequences when possible",
    "Strong representation in court",
    "Protection of your rights throughout the process",
    "Better bail or bond terms when applicable",
  ];
    ...
    <section className="py-16 bg-gradient-to-r from-mpl-navy to-mpl-blue text-white">
      <div className="container-custom text-center">
        ...
        <p className="text-lg text-gray-100 mb-8 max-w-2xl mx-auto">
          Get legal guidance now to manage your situation strategically.
        </p>
        <Link
          to="/contact"
      ...
      <div className="container-custom max-w-2xl">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600">
            Reach out to discuss your warrant situation and learn how we can
            help.
          </p>
        </div>
