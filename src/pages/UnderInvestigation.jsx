...
const UnderInvestigation = () => {
  return (
    <div className="bg-gray-50 min-h-screen">
      <CleanServiceHero
        title="Under Investigation Lawyer in San Antonio"
        subtitle="Proactive legal guidance before charges are filed."
        opening={[
          "If law enforcement has contacted you or you believe you are under investigation, what you do next matters.",
          "Speaking too soon or without guidance can create serious problems.",
        ]}
        infoTitle="What This Means"
        infoDescription="You may not be charged yet, but the situation can escalate quickly depending on how it is handled."
      />
      <WhyChooseSection />
      <ProcessSection />
      <BenefitsSection />
      ...
      <div className="container-custom relative z-10 text-left">
        ...
        >
          ...
          <h2 className="text-xl md:text-2xl text-white/90 font-semibold mb-4">
            Pre-Charge Defense & Investigation Guidance
          </h2>
          <p className="text-lg md:text-xl lg:text-2xl text-gray-100 max-w-2xl font-light leading-relaxed drop-shadow-md">
            If law enforcement has contacted you or you believe you are under
            investigation, what you do next matters. Speaking too soon or
            without guidance can create serious problems. We step in early to
            protect your rights.
          </p>
  ...
  const features = [
    {
      ...
      desc: "Early legal guidance can prevent charges or significantly weaken a case against you.",
    },
    {
      icon: Shield,
      title: "Rights Protection",
      desc: "We ensure your constitutional rights are protected during the investigation phase.",
    },
    {
      icon: FileText,
      title: "Communication Strategy",
      desc: "We guide you on when and how to communicate with law enforcement to protect yourself.",
    },
    {
      icon: Clock,
      title: "Proactive Defense",
      desc: "We work proactively to gather evidence and prevent charges when possible.",
    },
    {
      icon: Gavel,
      title: "Legal Guidance",
      desc: "We provide clear counsel on your options and the potential risks ahead.",
    },
    {
      icon: Phone,
      title: "Immediate Support",
      desc: "We're available immediately when you need guidance about the investigation.",
    },
  ];
      ...
      <div className="container-custom">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Investigations can escalate to charges quickly. Early action may
  ...
  const steps = [
    {
      ...
      desc: "We understand your legal position and help you identify what information law enforcement may have.",
    },
    {
      title: "Evidence Analysis",
      desc: "We analyze the strength of any evidence and identify potential weaknesses in the case.",
    },
    {
      title: "Communication Plan",
      desc: "We develop a strategy for if and when you need to communicate with investigators.",
    },
    {
      title: "Rights Assertion",
      desc: "We help you properly exercise your rights to remain silent and request counsel if contacted.",
    },
    {
      title: "Proactive Defense",
      desc: "We gather evidence, interview witnesses, and build a defense before charges are filed.",
    },
    {
      title: "Prevention or Mitigation",
      desc: "We work to prevent charges or ensure charges are dismissed or minimized if filed.",
    },
  ];
      ...
      <div className="container-custom">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6">
            Our Pre-Charge Defense Strategy
          </h2>
...
const BenefitsSection = () => {
  const benefits = [
    "Prevention of charges when possible",
    "Weakened prosecution case if charges are filed",
    "Protection of your rights and statements",
    "Clear understanding of your legal situation",
    "Proactive gathering of evidence",
    "Better positioning for negotiations or trial",
  ];
  ...
  return (
    <section className="py-24 bg-white">
      <div className="container-custom">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-serif font-bold text-mpl-navy mb-6">
            What Early Action Can Achieve
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Getting ahead of the investigation can significantly impact the
            outcome
          </p>
        </div>
    ...
    <section className="py-16 bg-gradient-to-r from-mpl-navy to-mpl-blue text-white">
      <div className="container-custom text-center">
        <h2 className="text-3xl md:text-4xl font-serif font-bold mb-6">
          If you think you're under investigation, don't wait
        </h2>
        <p className="text-lg text-gray-100 mb-8 max-w-2xl mx-auto">
          Early legal guidance can prevent charges or significantly improve your
          position.
        </p>
        <Link
          to="/contact"
      ...
      <div className="container-custom max-w-2xl">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600">
            Reach out immediately if you believe you're under investigation.
          </p>
        </div>
