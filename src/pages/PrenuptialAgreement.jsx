  ...
  const features = [
    {
      ...
      desc: "We help protect your pre-marital assets, business interests, and inheritance from potential division in divorce.",
    },
    {
      icon: Coins,
    ...
    },
    {
      ...
      desc: "We prepare detailed prenuptial agreements that address all relevant issues and comply with Texas law.",
    },
    {
      icon: Scale,
      title: "Legal Compliance",
      desc: "We ensure your prenuptial agreement meets all legal requirements and will be enforceable in court.",
    },
    {
      icon: HeartHandshake,
  ...
  const steps = [
    {
      ...
      desc: "We discuss your assets, goals, and concerns to determine what should be included in your prenuptial agreement.",
    },
    {
      id: 2,
      icon: Search,
    ...
    },
    {
      ...
      desc: "We draft a comprehensive prenuptial agreement that addresses your specific needs and complies with Texas law.",
    },
    {
      id: 4,
      icon: MessageCircle,
    ...
    },
    {
      ...
      icon: FileCheck,
      title: "Execution",
      desc: "We oversee the proper execution of the prenuptial agreement before marriage to ensure legal validity.",
    },
  ];
  ...
  const items = [
    {
      ...
      desc: "Define how property will be divided in case of divorce, including pre-marital assets and marital property.",
    },
    {
      icon: Coins,
    ...
    },
    {
      ...
      desc: "Define responsibility for pre-marital debts and how marital debts will be handled.",
    },
    {
      icon: PieChart,
      title: "Financial Planning",
          ...
          <div className="flex-1">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h2 className="text-2xl md:text-3xl font-bold font-serif">
                Free Resource: "The Texas Prenup Checklist"
              </h2>
            </div>
