      ...
      <div className="container-custom relative z-10 text-center">
        ...
        >
          ...
          <p className="text-lg md:text-xl lg:text-2xl text-gray-100 max-w-2xl mx-auto font-light leading-relaxed drop-shadow-md">
            Aggressive defense against theft, burglary, and property damage charges to safeguard your record.
          </p>
        </motion.div>
      </div>
      ...
      <div className="container-custom relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
        <div className="text-center md:text-left">
          ...
          <p className="text-white/80 max-w-2xl text-lg">
            A conviction can affect employment and housing opportunities. We fight to keep your record clean.
          </p>
        </div>
  ...
  const steps = [
    {
      ...
      title: "Case Review",
      icon: FileSearch,
      desc: "We thoroughly examine the evidence, including police reports, surveillance footage, and witness statements.",
      bullets: [
        "Evidence analysis",
        "Procedural review",
        "Value assessment",
    ...
    },
    {
      ...
      icon: Scale,
      desc: "We develop a customized defense strategy, challenging the prosecution's proof of intent or ownership.",
      bullets: [
    ...
    },
    {
      ...
      title: "Negotiation",
      icon: Users,
      desc: "We negotiate with prosecutors to reduce charges or dismiss the case, potentially through restitution agreements.",
      bullets: [
        "Plea bargaining",
        "Charge reduction",
        "Diversion programs",
    ...
    },
    {
      ...
      title: "Trial Defense",
      icon: Gavel,
      desc: "If a fair resolution isn't reached, we are prepared to defend your innocence at trial.",
      bullets: [
        "Jury selection",
      ...
      <div className="container-custom">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">
            We understand the nuances of property crime laws and use our expertise to build a solid defense for you.
          </p>
        </div>
        ...
        <div className="bg-mpl-navy rounded-3xl p-12 md:p-20 text-center relative overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <p className="text-xl text-white/80 mb-10 leading-relaxed">
              Don't let a theft charge tarnish your future. Contact us for a strategic defense consultation.
            </p>
            <Link
              to="/contact"
