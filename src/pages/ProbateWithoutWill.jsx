              ...
              <div className="space-y-6 my-12">
                <div className="border-l-4 border-mpl-gold pl-4">
                  ...
                  <p className="text-gray-700">
                    ...
                    estate is typically divided between them. Community property
                    and separate property may be treated differently.
                  </p>
                </div>
                ...
                <div className="border-l-4 border-mpl-gold pl-4">
                  ...
                  <p className="text-gray-700">
                    If only a spouse survives, they generally inherit the entire
                    estate (with exceptions for non-marital property).
                  </p>
                </div>
                ...
                <div className="border-l-4 border-mpl-gold pl-4">
                  ...
                  <p className="text-gray-700">
                    ...
                    succession through parents, siblings, grandparents, and more
                    distant relatives in a specific order.
                  </p>
                </div>
              </div>
            </motion.div>
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      Court-supervised administration following Texas intestacy
                      laws, appropriate for larger estates or complex
                      circumstances.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      ...
                      affidavit process to collect and distribute assets without
                      formal probate.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      A specialized procedure to transfer real property without
                      administering the entire estate, used when only land needs
                      to transfer.
                    </p>
                  </div>
                </div>
